...
const GameAssets = (function () {
  ...
  const TARGET_SHEETS = {
    ...
    heal_1:        { src: 'assets/effects/target/heal_1.png',        fw: 48, fh: 48 },
    ...
    whirlwind_green:{ src: 'assets/effects/target/whirlwind_green.png', fw: 48, fh: 48 },
  ...
  return {
    ...
    manifests: {
      ...
      EFFECT_SHEETS, TARGET_SHEETS, CREATURES
    }
  };
})();
